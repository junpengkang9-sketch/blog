...
> 原则：优先官方文档和官方 GitHub；只保留少量真正值得看的文章；每篇都加入核心知识提炼，而不是做链接堆积。

## Frontend

### Architecture
- [微前端](docs/frontend/01-微前端.md)

### Engineering
- [前端工程化](docs/frontend/02-前端工程化.md)
- [构建工具](docs/frontend/03-构建工具.md)
...
- [LLM 基础](docs/ai/01-LLM基础.md)
- [RAG 与知识库](docs/ai/02-RAG与知识库.md)
- [Agent 开发](docs/ai/03-Agent开发.md)
- [MCP](docs/ai/04-MCP.md)
- [AI 评测与可观测性](docs/ai/05-AI评测与可观测性.md)
...
1. 它解决什么问题？
2. 官方文档和官方 GitHub 在哪里？
3. 哪一篇资料真正值得完整阅读？
4. 我应该从中记住什么，而不是只收藏链接？
